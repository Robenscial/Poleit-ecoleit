<?php
session_start();
require('../action/updatePublication.php');
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-center u-form u-form-1">
            <form action="" method="POST" enctype="multipart/form-data" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;">
                <p class="u-align-center u-custom-font u-form-group u-form-text u-heading-font u-text u-text-palette-4-dark-1 u-text-1">METTRE A JOUR</p>
                <div class="u-form-group u-form-name u-label-none">
                    <label for="name-6797" class="u-label">Name</label>
                    <input type="text" placeholder="titre" id="name-6797" name="title" value="<?php echo $publicationContent['TITLE'];?>" class="u-input u-input-rectangle" required="">
                </div>
                <div class="u-form-group u-form-message u-label-none">
                    <label for="message-6797" class="u-label">Address</label>
                    <textarea placeholder="​contenu" rows="4" cols="50" id="message-6797" name="content" class="u-input u-input-rectangle" required=""><?php echo $publicationContent['TEXT'];?></textarea>
                    <input type="text" name="picture" value="<?php echo $publicationContent['PICTURE'];?>" hidden="hidden">
                </div>
                <input type="file" name="image">
                <input type="text" name="id" value="<?php echo $publicationContent['ID'];?>" hidden="hidden">
                <div class="u-align-left u-form-group u-form-submit">
                    <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-hover-palette-4-light-1 u-palette-4-dark-2 u-btn-1">Modifier </a>
                    <input type="submit" name="update" class="u-form-control-hidden">
                </div>
            </form>
        </div>
                <?php
